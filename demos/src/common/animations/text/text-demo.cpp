...
class TextShader final : public Shader2D
{
...
void TextDemo::init()
{
    ...
    {
        render2D->load_font_directory("/Users/sigurdsevaldrud/documents/code/c++/sigfx/assets/fonts");
    }
    ...
    const double font_size = get_resolution().x * 0.05;

...
double BarycentricTriangle::get_a() const { return a; }
double BarycentricTriangle::get_b() const { return b; }
double BarycentricTriangle::get_c() const { return c; }
double BarycentricTriangle::get_d() const { return d; }
double BarycentricTriangle::get_e() const { return e; }
double BarycentricTriangle::get_f() const { return f; }
double BarycentricTriangle::get_g() const { return g; }
double BarycentricTriangle::get_h() const { return h; }
double BarycentricTriangle::get_i() const { return i; }

...
Color4::Color4(const uint8_t r, const uint8_t g, const uint8_t b, const uint8_t a) : r(r), g(g), b(b), a(a) {}
Color4::Color4(const int r, const int g, const int b, const int a) : r(r), g(g), b(b), a(a) {}

Color4::Color4(const uint8_t r, const uint8_t g, const uint8_t b) : r(r), g(g), b(b), a(255) {}
Color4::Color4(const int r, const int g, const int b) : r(r), g(g), b(b), a(255) {}

Color4::Color4(const double r, const double g, const double b, const double a) : r(static_cast<uint8_t>(r * 255.0)), g(static_cast<uint8_t>(g * 255.0)), b(static_cast<uint8_t>(b * 255.0)), a(static_cast<uint8_t>(a * 255.0)) {}
Color4::Color4(const double r, const double g, const double b) : r(static_cast<uint8_t>(r * 255.0)), g(static_cast<uint8_t>(g * 255.0)), b(static_cast<uint8_t>(b * 255.0)), a(255) {}

Color4::Color4(const double x) : r(static_cast<uint8_t>(x * 255.0)), g(static_cast<uint8_t>(x * 255.0)), b(static_cast<uint8_t>(x * 255.0)), a(255) {}

Color4::Color4() : Color4(0, 0, 0, 0) {}

Color4 Color4::from_i32(const int32_t color)
{
    return Color4(
...
Color4 Color4::set_alpha(const uint8_t alpha) const
{
    return Color4(r, g, b, alpha);
}

Color4 Color4::set_alpha(const double alpha) const
{

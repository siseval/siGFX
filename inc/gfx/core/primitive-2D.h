...
namespace gfx
{
    ...
    public:
        ...
        struct RasterizeOutput
        {
            ...
            bool use_alphas = false;
            std::vector<double> alphas;
        };

        Primitive2D();

        virtual RasterizeOutput rasterize(const Matrix3x3d &transform) const = 0;
        ...
        UUID get_id() const;
        Vec2d get_uv(Vec2d point) const;

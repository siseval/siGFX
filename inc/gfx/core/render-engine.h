...
public:
    ...
    std::shared_ptr<Cuboid3D> create_cuboid(const double x, const double y, const double z, const double size_x, const double size_y, const double size_z, const Color4 color, const Shader3D shader = DefaultShader3D()) const;
    ...
    std::shared_ptr<Plane3D> create_plane(const double x, const double y, const double z, const double size_x, const double size_y, const Color4 color, const Shader3D shader = DefaultShader3D()) const;
    ...
    std::shared_ptr<Sphere3D> create_sphere(const double x, const double y, const double z, const double radius, const Color4 color, const int segments = 16, const Shader3D shader = DefaultShader3D()) const;

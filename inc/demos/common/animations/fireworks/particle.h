...
public:
    ...
    Particle(std::shared_ptr<gfx::Render2D> renderer, const gfx::Vec2d position, const gfx::Vec2d velocity, const gfx::Vec2d size, const std::vector<gfx::Color4> &colors, const double lifespan)
